  ...
  const features = [
    {
      ...
      description:
        "High-quality signals with precise entry, target, and stop-loss levels.",
    },
    {
      icon: <Target className="h-9 w-9 text-amber-500" />,
      title: "Exclusive app access",
      description:
        "Get exclusive access to our premium mobile app with advanced features and real-time trading tools.",
    },
    {
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div
          ...
          style={{ backgroundColor: "var(--color-accent2)", opacity: 0.1 }}
        ></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <p
          className="text-lg max-w-3xl mx-auto mb-14"
          style={{ color: "var(--color-text-secondary)" }}
        >
          Designed to give you an edge in crypto trading with clarity, speed,
          and accuracy.
        </p>
